...
public class TabView extends FrameLayout {
    ...
    private static final int COLOE_DEFAULT = Color.parseColor("#ff000000");
    private static final int COLOE_SELECT = Color.parseColor("#FF45C01A");
    ...
    public void setProgress(float progress) {
        ...
        mTvTitle.setTextColor(evaluate(progress, COLOE_DEFAULT, COLOE_SELECT));
    }
